...
import re
import os.path
f = open("/Users/mansikothari/Documents/UD_MARCH/RC_11/Skills_Class/Skills_Report/Joris/01/data.txt","r")
...
for i in range(1,10):
    loc = "/Users/mansikothari/Documents/UD_MARCH/RC_11/Skills_Class/Skills_Report/Joris/01/IMAG"
    loc += str(i)
    loc += ".jpg"
